...
public class DateUtils {
	 ...
	 * @return
	 */
	public static String DateToStringEN(Date date, String pattern) {
		String dateString = null;
		if (date != null) {
			try {
				SimpleDateFormat dformat = new SimpleDateFormat(pattern, Locale.ENGLISH);
